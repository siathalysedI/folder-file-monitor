# AGGRESSIVE monitoring with NO PATH LIMITS
    (
...
# Reinstallation Script - Enhanced Folder File Monitor with Database Backup
# Run with: bash reinstall_folder_file_monitor.sh

set -e  # Stop on any error

echo "Reinstalling Enhanced Folder File Monitor..."
echo "============================================"
...
if [ "$1" = "--help" ] || [ "$1" = "-h" ]; then
    ...
    echo "  ✅ Automatic SQLite database backup (compressed)"
...
log_with_timestamp "Starting enhanced reinstallation with database backup"
...
if [ ! -f "$SCRIPT_FILE" ]; then
    echo "❌ ERROR: Enhanced Folder File Monitor is not installed"
...
# 5. Install new enhanced version with folder tracking
echo "Step 5: Installing enhanced version with folder tracking..."
...
chmod +x "$SCRIPT_FILE"
log_with_timestamp "Enhanced version installed with folder tracking"

# 6. Restart service
echo "Step 6: Restarting enhanced service..."
launchctl load "$PLIST_FILE"
sleep 3
log_with_timestamp "Enhanced service restarted"

# 7. Verify functionality
echo "Step 7: Verifying enhanced functionality..."
"$SCRIPT_FILE" status
...
echo "===================================="
echo ""
echo "Enhanced Folder File Monitor successfully reinstalled with:"
echo ""
echo "📦 Database backup created and compressed"
...
echo ""
echo "Service running automatically with enhanced features"
echo ""
if [ -f "$CONFIG_FILE" ] && [ -s "$CONFIG_FILE" ]; then
...
echo "   1. Create a folder like 'test-folder' in monitored directory"
echo "   2. Create a nested folder like 'test-folder/subfolder'"
echo "   3. Add files with .key extension inside nested folder"
echo "   4. Run: $SCRIPT_FILE recent 1 created"
echo "   5. You should see ALL folders and files listed as [FOLDER] and [FILE] CREATED"
echo ""
